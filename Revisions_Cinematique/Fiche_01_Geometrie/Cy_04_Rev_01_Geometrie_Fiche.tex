...
Dans certain mécanisme, on peut observer que deux vecteurs sont toujours orthogonaux. En utilisant le fait que le produit scalaire entre ces deux vecteurs est nul puis en projetant les vecteurs dans une même base et réalisant le calcul, il est possible de déterminer une loi entrée-sortie.
\end{methode}
\end{document}
