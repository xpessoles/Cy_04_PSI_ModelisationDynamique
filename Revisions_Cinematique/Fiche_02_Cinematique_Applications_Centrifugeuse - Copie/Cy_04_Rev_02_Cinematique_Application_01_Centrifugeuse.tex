...
\def\xxfigures{
\includegraphics[width=.8\textwidth]{images/centrifugeuse_1}
...
\begin{center}
\includegraphics[height=4cm]{images/centrifugeuse_2}
...
\subsection*{Cinématique -- Dérivation vectorielle}

\subparagraph{}
\textit{Calculer $\vectv{O_0}{S_1}{S_0}$ et $\vectv{O_1}{S_2}{S_1}$.}

\subparagraph{}
\textit{Calculer $\vectv{G}{S_2}{S_1}$ et $\vectv{G}{S_2}{S_0}$.}


\subsection*{Cinématique -- Composition du vecteur vitesse}
