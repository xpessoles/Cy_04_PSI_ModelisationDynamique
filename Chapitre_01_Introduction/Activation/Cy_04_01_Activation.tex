...
\item on notera $J_1$ le moment d'inertie du solide 1 selon l'axe $\couple{O_0}{\overrightarrow{y}_0}$ : $J_1=I_{\couple{O_0}{\overrightarrow{y_0}}}(S_1)$ ;
...
\item moment d'inertie de la vis à billes suivant l'axe $\overrightarrow{y}_0$ : $I_v = 2,1\,  10^{-4}\text{kg m}^2$.
\end{itemize}
De plus on notera : $\overrightarrow{\Omega}(S_1/R_0)=\dot{\theta}(t)\cdot \overrightarrow{y_0}$
%\end{minipage}
