...
\begin{itemize}
\item l'accélération minimale de l'axe transversal est de \SI{20}{m.s^{-2}};
...
\subparagraph{}
\textit{Quel est le temps nécessaire pour parcourir la course de la machine ?}

\subparagraph{}
\textit{Quelle est la distance minimale à parcourir pour atteindre la vitesse maximale ?}

\subparagraph{}
\textit{Quel est le couple minimal que doit fournir le moteur pour déplacer le chariot ?}
