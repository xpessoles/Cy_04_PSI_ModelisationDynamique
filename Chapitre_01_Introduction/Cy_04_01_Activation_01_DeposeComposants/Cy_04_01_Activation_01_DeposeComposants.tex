...
\begin{center}
\includegraphics[width=0.6\linewidth]{schema_cine_depose_composant.pdf}
\end{center}
...
\begin{center}
\includegraphics[width=.4\linewidth]{schema_cine_depose_translation.pdf}
\end{center}
%\end{minipage}
...
\begin{center}
\includegraphics[width=.4\linewidth]{schema_cine_depose_rotation.pdf}
\end{center}
%\end{minipage}
