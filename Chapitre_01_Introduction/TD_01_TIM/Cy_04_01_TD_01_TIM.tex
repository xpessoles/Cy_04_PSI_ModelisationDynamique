...
\subparagraph{}
\textit{Après avoir fair un schéma, écrire le principe fondamental de la statique appliqué au solide \textbf{1} réduit au point $G$ en projection sur la base $\base{x}{y}{z}$.}
\ifprof
\begin{corrige}
\end{corrige}
\else
