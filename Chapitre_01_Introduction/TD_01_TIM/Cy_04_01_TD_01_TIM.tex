...
\def\xxtitreexo{Véhicule TIM}%Motorisation du moteur Haibike}
...
\ifprof
\begin{corrige}
À la limite du glissement, on a $T_{01}=fN_{01}$ et $\dfrac{T_{01}}{N_{01}}=\tan\alpha$. Pour $\alpha_{lim}<f$ il y a donc roulement sans glissement. 
\end{corrige}
\else
\fi
