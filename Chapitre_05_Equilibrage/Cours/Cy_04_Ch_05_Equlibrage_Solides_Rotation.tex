...
$$
%\end{texteCache}
\item On peut exprimer $\overrightarrow{O_3G_1}$ et $\overrightarrow{O_3G_2}$ dans la base $b_3=\base{\overrightarrow{x}_3}{\overrightarrow{y}_3}{\overrightarrow{z}_{0,3}}$ :
%\begin{texteCache}
\begin{align*}
...
\item $D_s$, $E_s$ et $E_s$ les produits d'inertie du solide S dans la base $b_s=\base{\overrightarrow{x}_s}{\overrightarrow{y}_s}{\overrightarrow{z}_s}$
\end{itemize}
