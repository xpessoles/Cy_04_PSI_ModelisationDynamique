...
confondu avec le point $O$ (critère C206).


\subparagraph{}
\textit{Déterminer l’expression de $x_{G_C}$ afin de valider le critère C206.}
\ifprof
\begin{corrige}
\end{corrige}
\else
