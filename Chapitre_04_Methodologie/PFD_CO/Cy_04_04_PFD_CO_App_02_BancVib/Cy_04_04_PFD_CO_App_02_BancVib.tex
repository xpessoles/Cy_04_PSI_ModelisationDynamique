...
\subparagraph{}
\textit{Réaliser le graphe d'analyse du système.}
\ifprof
\begin{corrige}
\end{corrige}
\else
...
\subparagraph{}
\textit{Préciser les théorèmes à utiliser permettant de déterminer deux équations différentielles liant $x$, $\theta$ et leurs dérivées et les paramètres cinétiques et cinématiques utiles.}
\ifprof
\begin{corrige}
\end{corrige}
\else
...
\subparagraph{}
\textit{Déterminer ces deux équations.}
\ifprof
\begin{corrige}
\end{corrige}
\else
