...
\def\xxtitreexo{Exercices d'applications}%Système EOS \ifnormal $\star$ \else \fi \iftdifficile $\star\star\star$ \else \fi }
\def\xxsourceexo{\hspace{.2cm} \footnotesize{Stéphane Genouël}}
...
\def\xxpied{%
Révisions Statique -- Modèle de Coulomb\\% afin de valider leurs performances.\\
