...
Les liaisons entre le corps du vérin \textbf{$\bm{S_3}$} et le bâti \textbf{$\bm{S_0}$} d’une part et entre la tige du vérin \textbf{$\bm{S_2}$} et la porte de coffre \textbf{$\bm{S_1}$} d’autre part, sont des liaisons rotules de centres respectifs $A$ et $C$.
...
\begin{center}
\includegraphics[width=\linewidth]{images/fig_01_bis}
...
\item $k=\SI{1667}{N.m^{-1}}$ et écrasement de $\SI{300}{mm}$.
\item .
