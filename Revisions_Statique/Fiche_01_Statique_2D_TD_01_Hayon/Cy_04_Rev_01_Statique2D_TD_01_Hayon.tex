...
\subparagraph{}
\textit{En déduire la valeur numérique de l’accroissement $\Delta C_m$  de couple moteur en fonction de la présence d’un obstacle.}% (on supposera que le rendement de la transmission est unitaire).}
\ifprof
\begin{corrige}~\\
