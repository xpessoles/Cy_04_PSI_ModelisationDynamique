...
Le repère $\quadruplet{B}{x_t}{y_t}{z_0}$ est lié à la Terre. $\vect{y_t}$ est un vecteur unitaire vertical tel que l’accélération de la pesanteur s’écrit $\vect{g}=-g\vect{y_t}$ avec $g=\SI{9,81}{m.s^{-2}}$. $\vect{x_t}$ est un vecteur unitaire horizontal. La liaison pivot entre
