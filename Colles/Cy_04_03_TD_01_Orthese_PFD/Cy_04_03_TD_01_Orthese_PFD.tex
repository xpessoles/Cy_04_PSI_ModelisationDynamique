...
et liée à la fois au bras et à la main, elle offre une résistance aux mouvements de la main. 
...
\begin{center}
\includegraphics[width=.9\linewidth]{fig_04_01}

\includegraphics[width=.9\linewidth]{fig_04_02}
\end{center}
...
\subparagraph{}\textit{Exprimer le $\torseurdyn{\text{Bras}}{R_0}$ au point $O$.}
...
\subparagraph{}\textit{Exprimer le $\torseurdyn{\text{Avant-bras}}{R_0}$ au point $A$.}

\subparagraph{}\textit{Exprimer le $\torseurdyn{\text{Bras+Avant-bras}}{R_0}$ au point $O$.}
