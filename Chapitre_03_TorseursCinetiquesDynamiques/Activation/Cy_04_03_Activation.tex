...
\def\xxtitreexo{Activation -- Eolienne}%Motorisation du moteur Haibike}
...
\subparagraph{} \textit{Déterminer la composante suivant $\overrightarrow{z}_0$ du moment dynamique au point K de la girouette 1 dans son mouvement par rapport au support 0, notée $\overrightarrow{z}_0\cdot \vectmd{K}{1}{0}$.}
