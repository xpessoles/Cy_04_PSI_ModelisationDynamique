...
\item action du réducteur: $\torseurstat{T}{1_m}{E}=\torseurl{\vect{0}}{C_m \vect{x_0}}{O_1}$ avec $\vectm{O_1}{1}{E}\cdot \vect{x_0}=0$;
...
$-Lm_4\cos\theta_{10}\ddot{h}(t) =C_m -m_4gL\cos\theta_{10}$
$ \Leftrightarrow C_m=m_4 L \cos\theta_{10} \left(g-\ddot{h}(t)\right) $.
