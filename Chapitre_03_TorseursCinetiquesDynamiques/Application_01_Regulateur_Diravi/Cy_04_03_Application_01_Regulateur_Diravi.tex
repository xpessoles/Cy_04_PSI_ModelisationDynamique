...
\def\xxtitreexo{Application -- Régulateur centrifuge}%Motorisation du moteur Haibike}
...
\subparagraph{}\textit{Discuter de la pertinence de ces hypothèses. Vous pourrez éventuellement les remettre en cause. }
...
+ \left(-\left( d_1\vect{z_0}+L_1\vect{y_1} \right)\wedge \dot{\theta}_1 \vect{z_1}\right)$
$=
 L_2 \dot{\theta}_2 \vect{z_2}-\dot{\theta}_1L_1\vect{x_1}
$
...
$\torseurci{S_2}{R_0}
=\torseurl{
m_2\left(  L_2 \dot{\theta}_2 \vect{z_2}-\dot{\theta}_1L_1\vect{x_1}\right)
}{
...
$\vectg{G_2}{S_2}{R_0}
=\left[\dfrac{\text{d}\left(  L_2 \dot{\theta}_2 \vect{z_2}-\dot{\theta}_1L_1\vect{x_1}\right)}{\dd t}\right]_{R_0}
=L_2 \dot{\theta}_2 \left( \dot{\theta}_1 \sin\theta_2 \vect{x_{1,2}} -\dot{\theta}_2 \vect{y_2} \right)
- L_1 \dot{\theta}_1^2 \vect{y_1}
$
...
%+\\
%-D_2\dot{\theta}_1\dot{\theta}_2\cos\theta_2 -C_2 \dot{\theta}_1\dot{\theta}_2\sin\theta_2
%+
%\end{pmatrix}_{B_2}
%\begin{pmatrix}
%A_2\dot{\theta}_2 \\
